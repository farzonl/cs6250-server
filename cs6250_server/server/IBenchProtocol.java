...
public interface IBenchProtocol {
  ...
  /**
   */
  java.util.List<java.nio.ByteBuffer> addCompressedFrames(java.util.List<java.nio.ByteBuffer> frames, server.Compress algo) throws org.apache.avro.AvroRemoteException;
  ...
  public interface Callback extends IBenchProtocol {
     ...
     * @throws java.io.IOException The async call could not be completed.
     */
    void addCompressedFrames(java.util.List<java.nio.ByteBuffer> frames, server.Compress algo, org.apache.avro.ipc.Callback<java.util.List<java.nio.ByteBuffer>> callback) throws java.io.IOException;
  }
}